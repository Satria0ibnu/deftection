...
try:
    ...
    print("Detection core not available")
...
def test_system():
    ...
    try:
        ...
        if detector.is_ready():
            ...
            print(f"   Models: {'' if system_info['models_loaded'] else 'no'}")
            print(f"   Detection Core: {'' if system_info['detection_core_available'] else 'no'}")
