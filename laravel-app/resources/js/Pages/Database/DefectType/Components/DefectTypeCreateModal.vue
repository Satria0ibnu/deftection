...
const handleSuccess = (response) => {
    ...
    successToast("Defect Type created successfully!");
};
...
const handleError = (errors) => {
    ...
    errorToast("Failed to create defect type. Please check your input.");
};
...
<template>
    <FormModal
        ...
        description="Fill the defect type information below and click add to save changes."
        submit-text="Add Defect Type"
        loading-text="Creating Defect Type..."
    ...
    >
        <div class="space-y-4">
            ...
            <div>
                <FormModalLabel for="description" required>
                    Description
                </FormModalLabel>
                <FormModalInput
                    id="description"
